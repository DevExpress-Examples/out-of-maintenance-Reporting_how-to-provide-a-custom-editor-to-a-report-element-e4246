...
Namespace CustomEditorSample
	Partial Public Class App
		...
		Public Sub New()
			ServiceKnownTypeProvider.Register(Of ChangeImageSizeModeAction)()
			ServiceKnownTypeProvider.Register(Of ImageSizeMode)()
			AddHandler Startup, AddressOf Application_Startup
            'AddHandler Exit, AddressOf Application_Exit
